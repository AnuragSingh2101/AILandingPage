...
![Nexus Landing Page Hero](landing-page.png)

---

### Core Features & Testimonials
![Nexus Features Section](features.png)
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/AnuragSingh2101/AILandingPage.git
   cd AILandingPage
   ```

2. **Run a local development server** (recommended for full functionality of local resource imports and fonts):
   Using Node.js:
   ```bash
...
3. **Open the browser**:
   Navigate to `http://localhost:8080/LandingPage.html` to view the page.
